...
def load_spec(name, memory_id: str = None, n_mem_states: int = 2, fuzz: float = 0.1, **kwargs):
    """
    ...
    :param fuzz:            for memory_id="f" - how much fuzz do we use for the fuzzy identity function.
