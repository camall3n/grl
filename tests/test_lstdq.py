...
def test_lstdq():
    ...
    _, mc_vals, td_vals, _ = analytical_pe(pi, pomdp)

    vlstd_lambda_0, qlstd_lambda_0, _ = lstdq_lambda(pi, pomdp, lambda_=0)
    vlstd_lambda_1, qlstd_lambda_1, _ = lstdq_lambda(pi, pomdp, lambda_=1)
