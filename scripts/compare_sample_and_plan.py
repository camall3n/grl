...
agent = ActorCritic(
    ...
    study_name='compare_sample_and_plan/' + args.study_name,
)
...
lstd_v0, lstd_q0 = lstdq_lambda(pi.repeat(2, axis=0), mem_aug_mdp, lambda_=0)
lstd_v1, lstd_q1 = lstdq_lambda(pi.repeat(2, axis=0), mem_aug_mdp, lambda_=0.99999)
