...
def parse_args():
    ...
    parser.add_argument('--annealing_tmax', type=float, default=1e-3)
    parser.add_argument('--annealing_tmin', type=float, default=1e-6)
    parser.add_argument('--annealing_progress_fraction_at_tmin', type=float, default=0.5)
    parser.add_argument('--n_annealing_repeats', type=int, default=1)
