...
def check_samples():
    ...
    lambda_0 = 0.
    lambda_1 = 1.
    n_total_episode_samples = int(10)
    n_episodes_per_update = int(2)
    ...
    n_episodes_per_update = n_total_episode_samples
    ...
    for g in range(n_grad_updates):
        ...
        for ep in tqdm(sampled_episodes):
            ...
            for t in range(ep['actions'].shape[0] + 1):
                ...
                #     p_m_given_o, grad_pm = prob_mem_over_obs_grad_fn(mem_params, mem_aug_pi, mem_aug_amdp, obs, mem)
                ...
                # sampled_grads += (repacked_mem_v_obs - lstd_v1[obs]) * grad
                sampled_grads += lambda_discrep_grad_fn(mem_params, amdp, lstd_v1, mem_aug_pi, obs)
